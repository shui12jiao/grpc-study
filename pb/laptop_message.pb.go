...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x6b, 0x1a, 0x17, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x5f, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f,
	...
	0x70, 0x75, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x6d, 0x79, 0x2e, 0x70, 0x63,
	0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x43, 0x50, 0x55, 0x52, 0x03, 0x63, 0x70, 0x75, 0x12, 0x23, 0x0a,
	0x03, 0x72, 0x61, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6d, 0x79, 0x2e,
	...
	0x32, 0x0e, 0x2e, 0x6d, 0x79, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x47, 0x50, 0x55,
	0x52, 0x04, 0x67, 0x70, 0x75, 0x73, 0x12, 0x2e, 0x0a, 0x08, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x79, 0x2e, 0x70, 0x63,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6d, 0x79, 0x2e, 0x70, 0x63, 0x62, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6d, 0x79, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
...
var file_laptop_message_proto_goTypes = []interface{}{
	(*Laptop)(nil),              // 0: my.pcbook.Laptop
	(*CPU)(nil),                 // 1: my.pcbook.CPU
	(*Memory)(nil),              // 2: my.pcbook.Memory
	(*GPU)(nil),                 // 3: my.pcbook.GPU
	(*Storage)(nil),             // 4: my.pcbook.Storage
	(*Screen)(nil),              // 5: my.pcbook.Screen
	(*Keyboard)(nil),            // 6: my.pcbook.Keyboard
	(*timestamp.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: my.pcbook.Laptop.cpu:type_name -> my.pcbook.CPU
	2, // 1: my.pcbook.Laptop.ram:type_name -> my.pcbook.Memory
	3, // 2: my.pcbook.Laptop.gpus:type_name -> my.pcbook.GPU
	4, // 3: my.pcbook.Laptop.storages:type_name -> my.pcbook.Storage
	5, // 4: my.pcbook.Laptop.screen:type_name -> my.pcbook.Screen
	6, // 5: my.pcbook.Laptop.keyboard:type_name -> my.pcbook.Keyboard
	7, // 6: my.pcbook.Laptop.updated_at:type_name -> google.protobuf.Timestamp
