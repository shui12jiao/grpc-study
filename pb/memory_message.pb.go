...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=my.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6b, 0x22, 0xaa, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14, 0x0a, 0x05,
	...
	0x32, 0x16, 0x2e, 0x6d, 0x79, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: my.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: my.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: my.pcbook.Memory.unit:type_name -> my.pcbook.Memory.Unit
