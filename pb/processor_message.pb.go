...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x6d, 0x79, 0x2e, 0x70, 0x63,
	...
	0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6d,
	0x79, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: my.pcbook.CPU
	(*GPU)(nil),    // 1: my.pcbook.GPU
	(*Memory)(nil), // 2: my.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: my.pcbook.GPU.memory:type_name -> my.pcbook.Memory
